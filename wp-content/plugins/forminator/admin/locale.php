...
"PDF file" => array( null, __("PDF file", "forminator" ), ), // src/form/components/modals/fields.js:251
"form" => array( null, __("form", "forminator" ), ), // src/form/components/modals/fields.js:254
"You can have only one Stripe field in your form for Stripe to work accurately. Please delete the existing Stripe field to add a new one." => array( null, __("You can have only one Stripe field in your form for Stripe to work accurately. Please delete the existing Stripe field to add a new one.", "forminator" ), ), // src/form/components/modals/fields.js:300
"You can have only one PayPal field in your form for PayPal to work accurately. Please delete the existing PayPal field to add a new one." => array( null, __("You can have only one PayPal field in your form for PayPal to work accurately. Please delete the existing PayPal field to add a new one.", "forminator" ), ), // src/form/components/modals/fields.js:311
"You can have only one payment field in your form. Please delete the existing payment field to add another one." => array( null, __("You can have only one payment field in your form. Please delete the existing payment field to add another one.", "forminator" ), ), // src/form/components/modals/fields.js:322
"You can have only one captcha field in your form for captcha to work accurately. Please delete the existing captcha field to add a new one." => array( null, __("You can have only one captcha field in your form for captcha to work accurately. Please delete the existing captcha field to add a new one.", "forminator" ), ), // src/form/components/modals/fields.js:332
"{{b}}Note{{/b}}: You can use the {{b}}Rich Text{{/b}} field to add form fields and custom text to your PDF." => array( null, __("{{b}}Note{{/b}}: You can use the {{b}}Rich Text{{/b}} field to add form fields and custom text to your PDF.", "forminator" ), ), // src/form/components/modals/fields.js:343
"Coming soon" => array( null, __("Coming soon", "forminator" ), ), // src/form/components/modals/fields.js:440
"Payment" => array( null, __("Payment", "forminator" ), ), // src/form/components/modals/fields.js:451
"Quotation" => array( null, __("Quotation", "forminator" ), ), // src/form/components/modals/fields.js:467
"Need access to pro form fields? {{link}}Upgrade to Pro{{/link}}" => array( null, __("Need access to pro form fields? {{link}}Upgrade to Pro{{/link}}", "forminator" ), ), // src/form/components/modals/fields.js:496
"Dismiss" => array( null, __("Dismiss", "forminator" ), ), // src/form/components/modals/fields.js:518
